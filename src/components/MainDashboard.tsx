      ...
      <div className="bg-white/80 backdrop-blur-xl border border-slate-100/60 p-6 rounded-3xl shadow-[0_4px_30px_rgb(0,0,0,0.02)] flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <select
            ...
            className="appearance-none bg-slate-50/80 border border-slate-200/60 hover:border-slate-300 text-slate-700 text-sm font-bold rounded-xl px-4 py-2.5 outline-none transition-colors w-24 text-center cursor-pointer"
          >
          ...
          <select
            ...
            className="appearance-none bg-slate-50/80 border border-slate-200/60 hover:border-slate-300 text-slate-700 text-sm font-bold rounded-xl px-4 py-2.5 outline-none transition-colors w-20 text-center cursor-pointer"
          >
          ...
          <select
            ...
            className="appearance-none bg-slate-50/80 border border-slate-200/60 hover:border-slate-300 text-slate-700 text-sm font-bold rounded-xl px-6 py-2.5 outline-none transition-colors cursor-pointer"
          >
          ...
          <button
            onClick={fetchData}
            className="bg-[#0072BC]/10 hover:bg-[#0072BC]/20 text-[#0072BC] p-2.5 rounded-xl transition-colors"
          >
      ...
      {topAlerts.length > 0 && (
        <div className="flex flex-wrap gap-3">
          {topAlerts.slice(0, 6).map((al, idx) => (
            <div
              key={idx}
              className={`${al.bg} ${al.border} border px-4 py-2.5 rounded-full flex items-center gap-2.5 transition-transform hover:scale-[1.02] cursor-default`}
            >
      ...
      <section className="bg-white rounded-[28px] p-6 lg:p-8 border border-slate-200 shadow-sm space-y-8">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="hidden sm:flex items-center gap-2 text-sm font-bold text-[#0072BC] hover:text-[#0a2540] transition-colors px-4 py-2 bg-slate-50 rounded-xl hover:bg-slate-100"
          >
      ...
      {hasAdvancedPermission(user, 'dashboard', 'quick_shortcuts', 'view_main_shortcuts') && (
        <section className="bg-gradient-to-l from-[#0072BC] to-[#0a2540] p-6 lg:p-8 rounded-[28px] text-white shadow-xl flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden">
          ...
          <div className="flex flex-wrap items-center justify-center md:justify-end gap-3 relative z-10 w-full md:w-auto">
            <button
              onClick={() => onNavigate("sales", "sales_quotations")}
              className="bg-white/10 hover:bg-white text-white hover:text-[#0a2540] border border-white/20 px-5 py-3 rounded-2xl text-xs font-black flex items-center gap-2 transition duration-300"
            >
            ...
            <button
              ...
              className="bg-white/10 hover:bg-white text-white hover:text-indigo-600 border border-white/20 px-5 py-3 rounded-2xl text-xs font-black flex items-center gap-2 transition duration-300"
            >
            ...
            <button
              onClick={() => onNavigate("sales", "sales_collections")}
              className="bg-white/10 hover:bg-white text-white hover:text-emerald-600 border border-white/20 px-5 py-3 rounded-2xl text-xs font-black flex items-center gap-2 transition duration-300"
            >
            ...
            <button
              onClick={() => onNavigate("production", "prod_orders")}
              className="bg-white/10 hover:bg-white text-white hover:text-amber-600 border border-white/20 px-5 py-3 rounded-2xl text-xs font-black flex items-center gap-2 transition duration-300"
            >
            ...
            <button
              ...
              className="bg-white/10 hover:bg-white text-white hover:text-fuchsia-600 border border-white/20 px-5 py-3 rounded-2xl text-xs font-black flex items-center gap-2 transition duration-300"
            >
            ...
            <button
              onClick={() => onNavigate("warehouse", "procurement_requests")}
              className="bg-white/10 hover:bg-white text-white hover:text-rose-600 border border-white/20 px-5 py-3 rounded-2xl text-xs font-black flex items-center gap-2 transition duration-300"
            >
        ...
        {historyLogs.length > 4 && (
          <div className="p-4 bg-slate-50/50 border-t border-slate-100 text-center">
            <button
              ...
              className="text-sm font-bold text-[#0072BC] hover:text-[#0a2540] transition-colors"
            >
              {showAllLogs
                ? lang === "ar"
                  ? "عرض القليل"
...
function KpiCard({
  ...
  return (
    <div
      onClick={onClick}
      className={`bg-white border border-slate-150 p-6 rounded-3xl flex flex-col justify-between transition-all duration-300 ${onClick ? "cursor-pointer hover:-translate-y-1 hover:shadow-lg" : "hover:shadow-md"}`}
    >
      <div className="flex justify-between items-start">
...
function MiniStat({ title, value, color = "text-slate-800", onClick }: any) {
  ...
  return (
    <div
      onClick={onClick}
      className={`${themeClasses} rounded-2xl p-4 border flex flex-col justify-center transition-all duration-300 group ${onClick ? "cursor-pointer hover:bg-white hover:shadow-md hover:border-slate-300 hover:-translate-y-0.5" : ""}`}
    >
      <p className="text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1.5 group-hover:text-slate-600 transition-colors">
        {title}
      </p>
      <p
        className={`text-xl font-black ${color} group-hover:scale-105 origin-left transition-transform`}
      >
        {value}
      </p>
    </div>
...
function InsightTag({ title, subtitle, value, color, bg, border }: any) {
  return (
    <div
      className={`shrink-0 w-[200px] p-4 rounded-2xl border ${border} ${bg} transition-all duration-300 hover:-translate-y-1 hover:shadow-sm`}
    >
...
function QuickBtn({ onClick, icon: Icon, label, color, hoverBorder }: any) {
  return (
    <button
      onClick={onClick}
      className={`bg-white border border-slate-200 px-5 py-3 rounded-2xl text-sm font-bold text-slate-700 shadow-sm flex items-center gap-3 transition-all hover:shadow hover:-translate-y-0.5 ${hoverBorder}`}
    >
