  ...
  const [jobRoles, setJobRoles] = useState<JobRole[]>([
    {
      ...
      basicMax: 7000,
      fieldAllowance: 800,
      kpiGoalName_ar: 'انحناء لا يقل عن ١٢ متر زجاج يوميا وبدون تشققات',
    ...
    },
    {
      ...
      basicMax: 9000,
      fieldAllowance: 1500,
      kpiGoalName_ar: 'تأمين تركيب ورفع لوحة كلادينج عملاقة في اقل من ٣ ساعات المسموح',
    ...
    },
    {
      ...
      basicMax: 8000,
      fieldAllowance: 600,
      kpiGoalName_ar: 'تقليل فاقد ألواح أكريليك وشيتات الكلادينج لأقل من ٣٪ شهرياً',
    ...
    },
    {
      ...
      basicMax: 12000,
      fieldAllowance: 0,
      kpiGoalName_ar: 'توليد ٣ منظور زوايا ثلاثية الأبعاد لكل مقترح واجهة',
    ...
    },
    {
      ...
      basicMax: 10000,
      fieldAllowance: 500,
      kpiGoalName_ar: 'تحقيق مستهدف مبيعات ربع سنوي ٢٠٠ ألف ريال سعودي',
